...

            {
                step: {
                    ...
                    body: [{
                            ...
                            click: {
                                text: 'some text',
                                selector: '[some-property=some-valid-selector1]',
                                isReturn: true
                            }
                        },
                        /// there must be something before the substep
                        {
                            subStep: {
                                body: [{
                                    click: {
                                        text: 'some text',
                                        selector: '[some-property=some-valid-selector-inSUBSTEP1]'
                                    }
                                }, {
                                    click: {
                                        text: 'some text',
                                        selector: '[some-property=some-valid-selector-inSUBSTEP2]',
                                        isReturn: true
                                    }
                                }]
                            }
                            ...
                            subStep: {
                                body: [{
                                    expect: {
                                        text: 'some text',
                                        expectCondition: 'someMethod2("[some-property=some-valid-selector-inSUBSTEP1]")',
            ...
            },
            {
                step: {
                    ...
                    body: [{
                        click: {
                            text: 'some text',
                            selector: '[some-property=some-valid-selector2]'
                        }
                    }, {
                        click: {
                            text: 'some text',
                            selector: '[some-property=some-valid-selector3]'
                        }
                    }, {
                        expect: {
                            text: 'some text',
                            expectCondition: 'someMethod2("[some-property=some-valid-selector1]")',
